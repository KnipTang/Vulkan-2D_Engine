#include "DAEGraphicsPipelineFill.h"
#include "DAEShader2DFill.h"
#include <stdexcept>
#include <vector>

void GraphicsPipelineFill::draw(const VkCommandBuffer& commandBuffer, VkExtent2D swapChainExtent, glm::vec3 newColors)
{
...
void GraphicsPipelineFill::initialize(const VkDevice& device)
{
	m_VkDevice = device;
}

void GraphicsPipelineFill::createGraphicsPipeline(const VkRenderPass& renderPass, DAEShader2DFill& shader)
{
...
void GraphicsPipelineFill::destroy()
{
