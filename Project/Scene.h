...
public:
	...
	static VerInd generateLine(float posX1, float posY1, float posX2, float posY2, float depth = 0, glm::vec3 color = { 1,1,1 });
	...
	static VerInd generateLineMouse(float posX1, float posY1, float posX2, float posY2, float depth = 0, glm::vec3 color = { 1,1,1 });
