...
VkPipelineShaderStageCreateInfo DAEShader3D::createFragmentShaderInfo(const VkDevice& vkDevice) {
...
VkPipelineShaderStageCreateInfo DAEShader3D::createVertexShaderInfo(const VkDevice& vkDevice) {
...
VkPipelineVertexInputStateCreateInfo DAEShader3D::createVertexInputStateInfo()
{
	VkPipelineVertexInputStateCreateInfo vertexInputInfo{};
	vertexInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;

	//m_VertexInputBindingDescription = Vertex3D::getBindingDescription();
	//m_VertexInputAttributeDescriptors = Vertex3D::getAttributeDescriptions();
...
VkPipelineInputAssemblyStateCreateInfo DAEShader3D::createInputAssemblyStateInfo()
{
...
VkShaderModule DAEShader3D::createShaderModule(const VkDevice& vkDevice, const std::vector<char>& code) {
